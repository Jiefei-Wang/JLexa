        ...
        try {
            when (call.method) {
                ...
                "setPlaybackEnd" -> {
                    ...
                    require(endMs == null || endMs > 0) { "endMs must be positive or null" }
                    require(positionMs == null || positionMs >= 0) { "positionMs must not be negative" }
                    player.setPlaybackEnd(endMs, positionMs)
                }
