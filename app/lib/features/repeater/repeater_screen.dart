...
class _RepeaterScreenState extends State<RepeaterScreen> {
  ...
  void didUpdateWidget(covariant RepeaterScreen oldWidget) {
    ...
    if (widget.activeLesson != null && widget.activeLesson?.id != oldWidget.activeLesson?.id) {
                  ...
                  ? Center(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            const Icon(Icons.graphic_eq, size: 64, color: AppColors.textTertiary),
                            const SizedBox(height: 16),
                            const Text('No audio selected', style: AppTypography.titleMedium),
