      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Row(
              children: [
                const Text('Snap to speech', style: TextStyle(fontSize: 12, color: AppColors.textSecondary)),
        ...
        Row(
          ...
          children: [
            ...
            const SizedBox(width: 6),
            IconButton(
              icon: const Icon(Icons.merge_type, size: 16, color: AppColors.textSecondary),
        ...
        Row(
          ...
          children: [
            ...
            Column(
              ...
              children: [
                IconButton(
                  icon: const Icon(Icons.skip_previous, size: 26, color: AppColors.textPrimary),
                  onPressed: onPrevSentence,
                  tooltip: 'Previous Sentence',
                ),
                const Text('Prev\nSentence', textAlign: TextAlign.center, style: TextStyle(fontSize: 10, color: AppColors.textSecondary)),
              ],
            ),
              ...
              children: [
                IconButton(
                  icon: Icon(
                    Icons.repeat_one,
                    size: 26,
                    color: isRepeatOne ? AppColors.primary : AppColors.textTertiary,
                  ),
                ...
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 10,
                    fontWeight: isRepeatOne ? FontWeight.bold : FontWeight.normal,
            ...
            Column(
              ...
              children: [
                IconButton(
                  icon: const Icon(Icons.skip_next, size: 26, color: AppColors.textPrimary),
  ...
  Widget _buildEditButton({
    ...
    return Expanded(
      child: OutlinedButton.icon(
        onPressed: onTap,
        icon: Icon(icon, size: 16, color: isPrimary ? AppColors.primary : AppColors.textSecondary),
        label: Text(
          label,
          style: TextStyle(
            fontSize: 12,
        ...
        style: OutlinedButton.styleFrom(
          ...
          backgroundColor: isPrimary ? AppColors.primaryLight : AppColors.surface,
